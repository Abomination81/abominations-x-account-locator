...
Abominations X Account Locator places X's public **Account based in** disclosure directly on ordinary and quoted posts. The badge color is customizable and defaults to Abomination green (`#39ff14`). Version 0.6 excludes the signed-in account from location lookups and badges.
...
1. Download and unzip `abominations-x-account-locator-v0.6.0.zip` from the installation page.
