...
Abominations X Account Locator places X's public **Account based in** disclosure directly on ordinary and quoted posts. The badge color is customizable and defaults to Abomination green (`#39ff14`).
...
1. Download and unzip `abominations-x-account-locator-v0.5.0.zip` from the installation page.
